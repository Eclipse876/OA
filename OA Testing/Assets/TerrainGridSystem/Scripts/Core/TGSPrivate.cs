...
namespace TGS {
    ...
    public partial class TerrainGridSystem : MonoBehaviour {
        ...
        bool applyingChanges, redrawing, applyingConfigs, pendingStartConfigApply;
        int cellUsedFlag;
        ...
        public void Init () {
            ...
            if (cells == null) {
                pendingStartConfigApply = true;
            } else if (Application.isPlaying) {
                ApplyTGSConfigs(startup: true);
            }
        }
        ...
        public void GenerateMap (bool reuseTerrainData = false, bool keepCells = false) {
            ...
            ApplyTGSConfigs(startup: false);
        }

        void ApplyTGSConfigs (bool startup) {
            if (applyingConfigs)
                return;
            ...
            for (int k = 0; k < configs.Length; k++) {
                ...
                if (!startup || !Application.isPlaying || config.ConfigApplyMode == TGSConfig.ApplyMode.OnlyOnStart) {
        ...
        public void Redraw (bool reuseTerrainData) {
            ...
            if (pendingStartConfigApply && cells != null) {
                pendingStartConfigApply = false;
                ApplyTGSConfigs(startup: true);
            }
        }
