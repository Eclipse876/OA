        ...
        public static ShipHandlingProfile Resolve(MovementProfileDefinition profile)
        {
            ...
            switch (profile != null ? profile.agility : ShipAgilityClass.Normal)
            {
                case ShipAgilityClass.VeryLow:
                    return Preset(14f, 0.35f, 0.5f, 24f, 8f, 5.5f, 7.0f, 0.012f, 0.55f);

                case ShipAgilityClass.Low:
                    return Preset(9f, 0.65f, 0.75f, 16f, 10f, 4.8f, 6.0f, 0.015f, 0.60f);

                case ShipAgilityClass.High:
                    return Preset(3f, 2.3f, 1.4f, 6f, 18f, 3.0f, 3.8f, 0.026f, 0.72f);

                case ShipAgilityClass.VeryHigh:
                    return Preset(1.8f, 4.0f, 1.8f, 3.5f, 25f, 2.2f, 3.0f, 0.035f, 0.80f);

                case ShipAgilityClass.Exceptional:
                    return Preset(1.0f, 6.5f, 2.2f, 2.2f, 32f, 1.6f, 2.3f, 0.045f, 0.90f);

                default:
                    return Preset(5.5f, 1.2f, 1.0f, 10f, 13f, 4.0f, 5.0f, 0.020f, 0.65f);
            }
        }
