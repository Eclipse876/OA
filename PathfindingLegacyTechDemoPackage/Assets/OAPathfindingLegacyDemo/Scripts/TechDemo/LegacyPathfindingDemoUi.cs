...
{
    public sealed class LegacyPathfindingDemoUi : MonoBehaviour
    {
        private LegacyPathfindingDemoController _controller;
        private Font _font;
        private InputField _seedInput;
        private InputField _obstacleInput;
        private Text _statusText;

        public void Initialize(LegacyPathfindingDemoController controller)
        {
        ...
        private void BuildUiTree()
        {
            ...
            CreateLabel(panelObject.transform, "OA Legacy Pathfinding Demo", 19, FontStyle.Bold, TextAnchor.MiddleLeft);
            CreateLabel(panelObject.transform, "Cell-by-cell A* baseline.", 13, FontStyle.Normal, TextAnchor.MiddleLeft);
            CreateSpacer(panelObject.transform, 4f);

            CreateMapControls(panelObject.transform);

            CreateSpacer(panelObject.transform, 8f);
            _statusText = CreateLabel(panelObject.transform, "Bootstrapping legacy demo...", 12, FontStyle.Normal, TextAnchor.UpperLeft);
            ...
            float height = 26f)
        {
            ...
            image.color = new Color(0.49f, 0.27f, 0.11f, 1f);
